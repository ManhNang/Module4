...
<head>
    ...
    <title>Cập Nhật Tờ Khai Y Tế #${declarationForm.id}</title>
...
<div class="container">
    <div class="header">
        ...
        <p>MÃ TỜ KHAI: #${declarationForm.id} | BỆNH NHÂN / NGƯỜI KHAI: ${declarationForm.fullName}</p>
    </div>

    <div class="nav-actions">
        <a href="${pageContext.request.contextPath}/declarations/view?id=${declarationForm.id}" class="btn-link">
            ⬅️ Quay lại trang xem chi tiết
        </a>
    ...
    <div class="form-content">
        ...
        <form:form modelAttribute="declarationForm" action="${pageContext.request.contextPath}/declarations/update" method="post" enctype="multipart/form-data">
            <form:hidden path="id"/>
            <form:hidden path="existingDocumentPath"/>
            <form:hidden path="existingDocumentName"/>
            ...
            <div class="form-row">
                <div class="form-group col-12">
                    ...
                    <form:input path="fullName" cssClass="form-control ${errors['fullName'] != null ? 'is-invalid' : ''}"/>
            ...
            <div class="form-row">
                <div class="form-group col-12">
                    ...
                    <form:input path="idCard" cssClass="form-control ${errors['idCard'] != null ? 'is-invalid' : ''}"/>
            ...
            <div class="form-row">
                <div class="form-group col-12">
                    ...
                    <form:input path="visitedCities" cssClass="form-control"/>
                </div>
            </div>
            ...
            <div class="form-row">
                ...
                <div class="form-group col-4">
                    ...
                    <form:input path="district" cssClass="form-control ${errors['district'] != null ? 'is-invalid' : ''}"/>
                ...
                <div class="form-group col-4">
                    ...
                    <form:input path="ward" cssClass="form-control ${errors['ward'] != null ? 'is-invalid' : ''}"/>
            ...
            <div class="form-row">
                <div class="form-group col-12">
                    <label>Địa chỉ nơi ở (Số nhà, phố, tổ dân phố...)</label>
            ...
            <div class="form-row">
                <div class="form-group col-6">
                    ...
                    <form:input path="phone" cssClass="form-control ${errors['phone'] != null ? 'is-invalid' : ''}"/>
            ...
            <div class="symptom-card">
                <label style="margin-bottom: 10px;">Trong vòng 14 ngày qua, Anh/Chị có xuất hiện triệu chứng:</label>
            ...
            <div class="symptom-card">
                <label style="margin-bottom: 10px;">Lịch sử phơi nhiễm:</label>
            ...
            <!-- Phần 5: Đính kèm tài liệu y tế -->
            <div class="section-title">
                <span class="badge-step">5</span> Đính kèm tài liệu y tế
            </div>

            <c:if test="${not empty declarationForm.existingDocumentPath}">
                <div style="margin-bottom: 12px;">
                    <span style="font-size: 13px; font-weight: 600;">Tệp hiện tại:</span>
                    <span class="current-file">📄 ${declarationForm.existingDocumentName != null ? declarationForm.existingDocumentName : declarationForm.existingDocumentPath}</span>
                </div>
            </c:if>

            <div class="file-upload-box">
                <p style="font-weight: 600; color: var(--primary);">Thay đổi tệp đính kèm (Để trống nếu giữ nguyên)</p>
                <input type="file" name="documentFile" accept="image/*,.pdf,.doc,.docx"/>
            </div>

            <button type="submit" class="btn-submit">
                LƯU CẬP NHẬT TỜ KHAI
            </button>
        </form:form>
    </div>
</div>
